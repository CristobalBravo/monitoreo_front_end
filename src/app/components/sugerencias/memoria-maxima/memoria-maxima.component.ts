...
@Component({
  selector: 'app-memoria-maxima',
  templateUrl: './memoria-maxima.component.html',
  styleUrls: ['./memoria-maxima.component.scss']
})
export class MemoriaMaximaComponent implements OnInit {
  ...
  method(){
    ...
    this.sugerenciaService.obtenerSugerenciasMemoriaMaxima(this.formData).subscribe((resp:any)=>{
      console.log(resp);
      if(resp.code==200){
        Swal.close();
      }
