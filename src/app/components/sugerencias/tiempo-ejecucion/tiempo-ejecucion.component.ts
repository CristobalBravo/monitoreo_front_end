...
@Component({
  selector: 'app-tiempo-ejecucion',
  templateUrl: './tiempo-ejecucion.component.html',
  styleUrls: ['./tiempo-ejecucion.component.scss']
})
export class TiempoEjecucionComponent implements OnInit {
  ...
  method(){
    ...
    this.sugerenciaService.obtenerSugerenciasTiempoDeEjecucion(this.formData).subscribe((resp:any)=>{
      console.log(resp);
      if(resp.code==200){
        Swal.close();
      }
